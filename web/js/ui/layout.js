 ...
 * All positional calculations delegate to the shared `cfg` singleton so that
 * multi-lane intersections are rendered correctly regardless of configuration.
 *
 * Coordinate convention (top-down view):
 ...
 */
export function queuePos(road, laneIndex, queueIndex) {
